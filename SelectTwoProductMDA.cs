...
public class SelectProductMDA
{
    ...
    public void SelecionarProdutoMDA()
    {
        ...
        // Validar o preco total do produto no carrinho
        ...
        // Validar a quantidade de produto no carrinho
        precoProduto = driver.FindElement(MobileBy.Id("com.saucelabs.mydemoapp.android:id/itemsTV")).Text;
        Assert.That(precoProduto, Is.EqualTo("2 Items"));
